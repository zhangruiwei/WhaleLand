...
namespace WhaleLand.Extensions.Resilience.Http
{
    ...
    {
        private readonly WhaleLand.DynamicRoute.IServiceLocator _serviceLocator;
        private readonly WhaleLand.LoadBalancers.DefaultLoadBalancerFactory<WhaleLand.DynamicRoute.ServiceEndPoint> _balancerFactory;
        private readonly WhaleLand.LoadBalancers.ILoadBalancer<WhaleLand.DynamicRoute.ServiceEndPoint> _loadBalancer;

        public HttpUrlResolver(
            WhaleLand.DynamicRoute.IServiceLocator serviceLocator)
        {
            this._serviceLocator = serviceLocator;
            this._balancerFactory = new WhaleLand.LoadBalancers.DefaultLoadBalancerFactory<WhaleLand.DynamicRoute.ServiceEndPoint>();
            this._loadBalancer = _balancerFactory.Get(() => new List<WhaleLand.DynamicRoute.ServiceEndPoint>());
