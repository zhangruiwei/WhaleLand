...
namespace WhaleLand.Extensions.Resilience.Http
{
    public class StandardHttpClient : IHttpClient
    {
       ...
       HttpMessageHandler httpMessageHandler)
        ...
        {
            using (var tracer = new WhaleLand.Extensions.OpenTracing.Tracer("HTTP DELETE"))
            {
        ...
        {
            using (var tracer = new WhaleLand.Extensions.OpenTracing.Tracer("HTTP GET"))
            {
                uri = await _httpUrlResolver.Resolve(uri);
        ...
        {
            using (var tracer = new WhaleLand.Extensions.OpenTracing.Tracer($"HTTP {method.Method.ToUpper()}"))
            {
                uri = await _httpUrlResolver.Resolve(uri);
