...
using OpenTracing;
using System;
using WhaleLand.Extensions.OpenTracing;
using WhaleLand.Extensions.OpenTracing.Jaeger;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        #region OpenTracking
        public static IWhaleLandOpenTracingBuilder AddJaeger(this IWhaleLandOpenTracingBuilder builder, IConfigurationSection configurationSection, Action<IOpenTracingBuilder> openTracingBuilder = null)
        {
        ...
        public static IWhaleLandOpenTracingBuilder AddJaeger(this IWhaleLandOpenTracingBuilder builder, Action<TracingConfiguration> action, Action<IOpenTracingBuilder> openTracingBuilder = null)
        {
