...
using WhaleLand.Extensions.EventBus.Kafka;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IWhaleLandEventBusHostBuilder AddKafka(this IWhaleLandEventBusHostBuilder hostBuilder, Action<KafkaOption> setupConnectionFactory)
        {
